        ...
        return (
            <main className='HomeSplash' role="main">
                <section className='header container text-center'>
                    <div className='section__1 header__1 card' id="card__bkgnd">
                        <h1 className='uppercase'>What is Numerology?</h1>
                ...
                <section className='how-it-works container'>
                    <div>
                        ...
                        <div className='section__3 d_flex dob'>
                ...
                <div className='signup__btn'>
                    <Link class="btn btn-primary" to='/register'>Create My Chart</Link>
                </div>
            </main>
        )
    }
